...
class ModuleMap {
    constructor(preferredAngularVersion) {
        ...
        this.nonScriptFiles = {};
        this.setUpAngularUtilityFunctions();
    ...
    setUpAngularUtilityFunctions() {
        this.noop = () => {};
        this.isArray = value => Array.isArray(value);
        this.isUndefined = value => value === undefined;
        this.isDefined = value => value !== undefined;
        this.isFunction = value => typeof value === 'function';
        this.lowercase = value => value.toString().toLowerCase();
    }
